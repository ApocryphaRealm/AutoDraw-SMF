...
namespace settings
{
	...
	namespace
	{
		...
		constexpr const char* kAutomationSection = "Automation";
		...
		void CaptureDefaults()
		{
			...
			defaults.enableAutoDraw = automation::enableAutoDraw;
			defaults.enableAutoSheathe = automation::enableAutoSheathe;
			defaults.sheatheDelaySeconds = automation::sheatheDelaySeconds;
			defaults.exemptBoundWeapons = automation::exemptBoundWeapons;
		}
		...
		void ReadFromCollection()
		{
...

			{
				...
				enableAutoDraw = Read<bool>(c, "bEnableAutoDraw:Automation", enableAutoDraw);
				enableAutoSheathe = Read<bool>(c, "bEnableAutoSheathe:Automation", enableAutoSheathe);
				sheatheDelaySeconds = Read<float>(c, "fSheatheDelaySeconds:Automation", sheatheDelaySeconds);
				exemptBoundWeapons = Read<bool>(c, "bExemptBoundWeapons:Automation", exemptBoundWeapons);
			}
		}
	}
	...
	void Init(const std::string& a_iniFileName)
	{
		...
		{
			using namespace automation;
			add("bEnableAutoDraw:Automation", enableAutoDraw);
			add("bEnableAutoSheathe:Automation", enableAutoSheathe);
			add("fSheatheDelaySeconds:Automation", sheatheDelaySeconds);
			add("bExemptBoundWeapons:Automation", exemptBoundWeapons);
		}
	...
	bool Save()
	{
		...
		ok &= WriteBool(kAutomationSection, "bEnableAutoDraw", automation::enableAutoDraw);
		ok &= WriteBool(kAutomationSection, "bEnableAutoSheathe", automation::enableAutoSheathe);
		ok &= WriteFloat(kAutomationSection, "fSheatheDelaySeconds", automation::sheatheDelaySeconds);
		ok &= WriteBool(kAutomationSection, "bExemptBoundWeapons", automation::exemptBoundWeapons);
